...
name_SEfit_Krafla='Krafla_SEfit_log_saveOK.mat';
load(name_SEfit_Krafla,'first_or_second','fitresult_se','gof_se','output_se','se_fit_mapp','fitresult_se_2','gof_se_2','output_se_2','se_fit_mapp_2', 'save_ydata','save_xdata','Mapp_cell','IP_flag_cell','t_center','depths_cell','GateWidth','coeff_alpha_Krafla','coeff_tauKWW_Krafla','coeff_beta_Krafla','rsquare_Krafla','current_cell','Rho_save','Res_save','file_in')
    ...
    for i=1:num_dp
        ...
        if isempty(fitresult_se{k,i})
            ...
            if rsquare_fit(k,i)<0.99 %0.998
                ...
                ydata_0=coeff_alpha_Krafla(k,i)*exp(-(xdata/coeff_tauKWW_Krafla(k,i)).^coeff_beta_Krafla(k,i));   
                ydata=ydata_0';
...
%% save variables
name_final='mat\Krafla_RTD_099_saveXk_dec24_different_interval.mat';
save(name_final,'sum_x','weightedTau_x','coeff_tau', 'coeff_x', 'save_ydata','save_xdata','coeff_alpha_Krafla','coeff_tauKWW_Krafla','coeff_beta_Krafla','rsquare_Krafla','file_in','current_cell','Rho_save','Res_save','rsquare_fit','rmse_fit','residuals_fit','resnorms_RTD','residuals_RTD')
